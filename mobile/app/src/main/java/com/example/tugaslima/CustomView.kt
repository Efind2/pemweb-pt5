...
class CustomView(context: Context, attributeSet: AttributeSet): View(context, attributeSet) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawText("@Username", textX, textY2, normalTextPaint)

        val textY3 = textY2 + 70f
        canvas.drawText("DM For Support !", textX, textY3, bioTextPaint)
        ...
        canvas.drawText("Https://username..", linktextX, linktextY, linkTextPaint)
